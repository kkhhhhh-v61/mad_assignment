...
class RiderList extends StatelessWidget {
  ...
  const RiderList({super.key, required this.items});
  ...
  Widget build(BuildContext context) {
    if (items.isEmpty) {
      return const Padding(
        ...
        child: FallbackMessage(
          ...
          description: 'There are currently no riders available.',
        ),
      );
    }
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return RiderItemCard(item: items[index]);
      },
    );
  }
}
...
class RiderItemCard extends StatelessWidget {
  ...
  const RiderItemCard({super.key, required this.item});
