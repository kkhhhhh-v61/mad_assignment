...
class CustomerOrderConfirmation extends StatelessWidget {
  ...
  void _returnToNavigation(BuildContext context, int tabIndex) {
    if (CustomerMainNavigation.hasCurrentState) {
      CustomerMainNavigation.switchToTab(tabIndex);
      ...
      Navigator.pushAndRemoveUntil(
        ...
        MaterialPageRoute(
          builder: (context) =>
              CustomerMainNavigation(initialIndex: tabIndex),
        ),
        (route) => false,
      );
    }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Spacer(),
                ElevatedButton.icon(
                  onPressed: () => _returnToNavigation(context, 2),
                ...
                OutlinedButton.icon(
                  onPressed: () => _returnToNavigation(context, 0),
