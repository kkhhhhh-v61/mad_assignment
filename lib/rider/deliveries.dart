    ...
    return Column(
      children: [
        ...
        Expanded(
          child: Builder(
            builder: (context) {
              List<Map<String, dynamic>> dummyDeliveries = [];
              ...
              dummyDeliveries = [
                {
                  ...
                  'date': 'Today, 12:45 PM',
                  'status': 'Active',
                  'customerName': 'Kai Hao',
                  'address': '123 Street Name, City',
                  'totalPrice': 'RM 54.60',
                  'info': 'Delivery in 15-20 mins',
                },
                {
                  'deliveryId': '#DEL-8488',
                  'date': 'Today, 12:15 PM',
                  'status': 'Active',
                  'customerName': 'Ahmad',
                  'address': '456 Office Tower, City',
                  'totalPrice': 'RM 36.80',
                  'info': 'Delivery in 5-10 mins',
                },
                {
                  'deliveryId': '#DEL-8470',
                  ...
                  'status': 'Completed',
                  'customerName': 'Tan',
                  'address': '789 Apartment Bldg, City',
                  'totalPrice': 'RM 31.80',
              ...
              final filteredDeliveries = dummyDeliveries
                  .where((delivery) => delivery['status'] == _selectedStatus)
                  .toList();

              return buildDeliveryList(context, filteredDeliveries, _selectedStatus);
            },
          ),
        ),
      ],
...
Widget buildDeliveryList(
  ...
  return ListView.builder(
    ...
    itemBuilder: (context, index) {
      return buildDeliveryCard(context, deliveries[index]);
    },
  );
}

Widget buildDeliveryCard(BuildContext context, Map<String, dynamic> delivery) {
