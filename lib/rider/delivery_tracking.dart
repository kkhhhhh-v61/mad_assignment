...
class DeliveryTracking extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
          const DeliveryTrackingMapPlaceholder(),
          Positioned(
          ...
          DeliveryTrackingSheet(delivery: delivery),
        ],
      ),
    );
  }
...
class DeliveryTrackingMapPlaceholder extends StatelessWidget {
  const DeliveryTrackingMapPlaceholder({super.key});
...
class DeliveryTrackingSheet extends StatelessWidget {
  ...
  const DeliveryTrackingSheet({super.key, required this.delivery});
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        delivery['customerName'] as String? ?? 'Customer',
                        style: const TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.bold,
                          color: Color.fromARGB(221, 0, 0, 0),
